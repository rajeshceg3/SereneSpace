...
export const SENTINEL_GUIDANCE_THRESHOLD = 0.8;
export const SENTINEL_GUIDANCE_DURATION = 3; // seconds
export const SENTINEL_DEEP_DIVE_THRESHOLD = 0.2;
export const SENTINEL_DEEP_DIVE_DURATION = 5; // seconds
